...
- **Automatic layout** — clean hierarchical layout with smooth, curved transitions; a parallel state's regions wrap into a grid (rather than one ever-widening row) so wide machines stay readable
